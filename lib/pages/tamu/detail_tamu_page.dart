...
import 'edit_data_tamu_page.dart';

class DetailTamuPage extends StatelessWidget {
  
  DetailTamuPage({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                //Title page
                MyText(text: 'Detail Tamu', fontSize: 24, fontWeight: FontWeight.w600),
                ...
                Row(
                  ...
                  children: [
                    MyText(text: 'Stephen Hawking', fontSize: 24, fontWeight: FontWeight.bold),
                  ],
                ),
                const SizedBox(height: 36),
                ...
                const SizedBox(height: 8,),
                MyText(text: 'Scientist', fontSize: 14, fontWeight: FontWeight.w400),
                const Divider(thickness: 1, color: Color.fromRGBO(76, 103, 147, 1)),
                const SizedBox(height: 5,),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: (){
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>EditDataTamuPage()));
                    }, 
