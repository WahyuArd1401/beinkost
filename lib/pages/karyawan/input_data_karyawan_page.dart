...
class InputDataKaryawanPage extends StatefulWidget {
  InputDataKaryawanPage({super.key});

  @override
  State<InputDataKaryawanPage> createState() => _InputDataKaryawanPage();
}

class _InputDataKaryawanPage extends State<InputDataKaryawanPage> {
  final _formField = GlobalKey<FormState>();
  final namaController = TextEditingController();
  final kosController = TextEditingController();
          ...
          child: Padding(
            ...
            child: Form(
              ...
              children: [
                ...
                //Title page
                MyText(text: 'Input Data Karyawan', fontSize: 24, fontWeight: FontWeight.w600),
                const SizedBox(height: 20),

                //Nama
                MyText(text: 'Nama Karyawan', fontSize: 12, fontWeight: FontWeight.w700),
                ...
                // Kos
                MyText(text: 'Kos', fontSize: 12, fontWeight: FontWeight.w700),
                const SizedBox(height: 6),
                TextFormField(
                  controller: kosController,
                  decoration: InputDecoration(
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(8),
                      borderSide: const BorderSide(color: Color.fromRGBO(76, 103, 147, 1))
