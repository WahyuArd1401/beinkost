...
class EditDataKaryawanPage extends StatefulWidget {
  EditDataKaryawanPage({super.key});

  @override
  State<EditDataKaryawanPage> createState() => _EditDataKaryawanPage();
}

class _EditDataKaryawanPage extends State<EditDataKaryawanPage> {
          ...
          child: Padding(
            ...
            child: Form(
              ...
              children: [
                ...
                //Title page
                MyText(text: 'Edit Data Karyawan', fontSize: 24, fontWeight: FontWeight.w600),
