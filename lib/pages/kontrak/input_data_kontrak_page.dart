...
class InputDataKontrakPage extends StatefulWidget {
  InputDataKontrakPage({super.key});

  @override
  State<InputDataKontrakPage> createState() => _InputDataKontrakPage();
}

class _InputDataKontrakPage extends State<InputDataKontrakPage> {
          ...
          child: Padding(
            ...
            child: Form(
              ...
              children: [
                ...
                //Title page
                MyText(text: 'Input Data Kontrak', fontSize: 24, fontWeight: FontWeight.w600),
