...
class TambahFasilitasKamarPage extends StatefulWidget {
  
  State<TambahFasilitasKamarPage> createState() => _TambahFasilitasKamarPage();
}

class _TambahFasilitasKamarPage extends State<TambahFasilitasKamarPage> {
  String? _value;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                //Title page
                MyText(text: 'Tambah Fasilitas Kamar', fontSize: 24, fontWeight: FontWeight.w600),
                const SizedBox(height: 9),
                MyText(text: 'Kamar 1 | Lantai 3', fontSize: 24, fontWeight: FontWeight.w600),
