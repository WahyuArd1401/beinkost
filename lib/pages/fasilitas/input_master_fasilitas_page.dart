...
class InputMasterFasilitasPage extends StatefulWidget {
  
  State<InputMasterFasilitasPage> createState() => _InputMasterFasilitasPage();
}

class _InputMasterFasilitasPage extends State<InputMasterFasilitasPage> {
  String? _value;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                //Title page
                MyText(text: 'Input Data Fasilitas', fontSize: 24, fontWeight: FontWeight.w600),
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton.icon(
                      ...
                      label: MyWhiteText(text: 'Tambah Form', fontSize: 12, fontWeight: FontWeight.w400)
                    )
                  ],
                ),
